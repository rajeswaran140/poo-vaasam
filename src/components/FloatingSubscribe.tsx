  ...
  return (
    <div className={`fixed right-6 z-50 flex items-center gap-1 animate-fade-in-up ${current ? 'bottom-28' : 'bottom-6'}`}>
      <a
        ...
        className="group inline-flex h-12 w-12 items-center justify-center rounded-full bg-orange-600 text-white shadow-2xl shadow-black/40 ring-1 ring-white/20 transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-300"
      >

...
import { LucideIcon, LayoutDashboard, FileText, Folder, Tag, Image, Globe, Settings, LogOut, Plus, Mail, PlaySquare, Music } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      >
        ...
        <nav className="mt-6">
          ...
          <NavLink href="/admin/songs" icon={Music}>
            Songs
          </NavLink>

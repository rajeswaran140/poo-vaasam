/**
 * GET /api/admin/compose/[jobId] — poll an async compose job. Admin-gated.
 *
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ jobId: string }> }) {
  ...
  try {
    ...
    console.error('[api/admin/compose/:jobId] fetch failed:', err instanceof Error ? err.message : String(err));
